...
VIDEO_ROOT="${VIDEO_ROOT:-/scratch/shahils/hd_epic_dataset/videos/HD-EPIC/Videos/P07}"
ANNOTATION_PATH="${ANNOTATION_PATH:-}"
METADATA_ROOT="${METADATA_ROOT:-/scratch/shahils/hd_epic_dataset/HD_EPIC_Intermediate_Data}"
